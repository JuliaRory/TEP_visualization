from PyQt5.QtWidgets import (
    QFrame, QGridLayout, QHBoxLayout, QVBoxLayout, QLabel, QScrollArea
)
...
class SettingsPanel(QFrame):
    ...
    def _setup_frame(self):
        ...
        _label1 = QLabel("Показать эпоху №", self)
        ...
        self._show_epoch = create_hbox([_label1, self.spin_box_show_epoch, self.button_show_epoch])

        _label2 = QLabel("Удалить эпоху №", self)
        ...
        self._remove_epoch = create_hbox([_label2, self.spin_box_remove_epoch, self.button_remove_epoch])
        ...
        self._aver_epoch = create_hbox([self.check_box_aver_mode, self.spin_box_aver_epoch, _label6, self.check_box_aver_epoch])

        _label7 = QLabel("Метод усреднения:", self)
        self.combo_box_aver = combo_box(self.params['aver_methods'], parent=self)
        self.button_aver = create_button('Применить', checkable=True, parent=self)
        self._aver_mode = create_hbox([_label7, self.combo_box_aver, self.button_aver])
        ...
        self.button_update_lowpass = create_button('Применить', checkable=True, parent=self)
        ...
        self.button_update_rereference = create_button('Применить', checkable=True, parent=self)
        ...
        self.button_update_baseline = create_button('Применить', checkable=True, parent=self)
        self._baseline_mode = create_hbox([self.check_box_baseline, self.combo_box_baseline, self.button_update_baseline])
        ...
        self.button_car = create_button('Применить',checkable=True, parent=self)
        ...
        self._car = create_hbox([self.check_box_car, self.button_car, _label_car, self.combo_box_channels])
