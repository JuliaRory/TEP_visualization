...
from widgets.tep_suppl_plot import TEPsSupplPlot
...
class TEPsSupplPanel(QFrame):
    ...
    def _setup_ui(self):
        self.figure = TEPsSupplPlot(self, single_w=0.8*self.width(), single_h=0.7*self.height(), w=self.width(), h=self.height(), Fs=self.params["SPEED"]['Fs'])
